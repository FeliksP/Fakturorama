 ...
 */
final class Version20200901124723 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE invoices (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(25) NOT NULL, issue_date DATE NOT NULL, buyer_name VARCHAR(255) NOT NULL, buyer_tax_id VARCHAR(15) NOT NULL, buyer_address VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE system (id INT AUTO_INCREMENT NOT NULL, company_name VARCHAR(255) NOT NULL, company_address VARCHAR(255) NOT NULL, company_tax_id VARCHAR(15) NOT NULL, default_currency VARCHAR(3) NOT NULL, company_account VARCHAR(40) NOT NULL, default_vat INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
